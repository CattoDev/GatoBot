/*
    https://github.com/matcool/ReplayBot/blob/rewrite/libraries/subprocess.hpp
*/
...
namespace subprocess {
    ...
    public:
        Popen() {}
        Popen(const std::string& command, DWORD creationFlags) {
            ...
            CreateProcessW(nullptr, buffer, nullptr, nullptr, true, creationFlags, nullptr, nullptr, &start_info, &m_proc_info);
